...
export default function PracticeAreasPage() {
  ...
  return (
    <main className="min-h-screen bg-navy pt-24">
      <SEO
        title="Faaliyet Alanlarımız | RS Avukatlık - Ceza, İcra, Aile Hukuku"
        description="Ceza Hukuku, Aile Hukuku, İş Hukuku, Ticaret Hukuku ve İcra İflas Hukuku alanlarında uzman avukatlık hizmeti."
        canonical="https://rsavukatlik.com/faaliyet-alanlarimiz"
      />
      <Helmet>
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://rsavukatlik.com/faaliyet-alanlarimiz"
              }
            ]
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "LegalService",
            "name": "RS Avukatlık",
            "url": "https://rsavukatlik.com/faaliyet-alanlarimiz",
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              "name": "Hukuki Hizmetler",
              "itemListElement": practiceAreasData.map((area) => ({
                "@type": "Offer",
                "itemOffered": {
                  "@type": "Service",
                  "name": area.title,
