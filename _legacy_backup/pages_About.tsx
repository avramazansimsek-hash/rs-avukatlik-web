...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-navy pt-24">
      <SEO
        title="Hakkımızda | RS Avukatlık - Av. Ramazan Şimşek"
        description="RS Avukatlık olarak müvekkillerimize uluslararası standartlarda, nitelikli ve çözüm odaklı hukuki danışmanlık hizmeti sunuyoruz."
        canonical="https://rsavukatlik.com/hakkimizda"
      />
      {/* Page Header */}
      {/* Page Header */}
      <section className="relative pt-20 pb-8 bg-gradient-to-b from-navy-light to-navy">
      ...
      {/* About Content */}
      <section ref={sectionRef} className="relative pt-8 pb-24">
