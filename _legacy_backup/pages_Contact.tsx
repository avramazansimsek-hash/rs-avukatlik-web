...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-navy pt-24">
      <SEO
        title="İletişim | RS Avukatlık - İstanbul Kartal"
        description="RS Avukatlık Bürosu'na ulaşın. Adres: Mustafa Kemal Cad, Hukukçular Towers, Kartal. Tel: +90 544 273 60 27"
        canonical="https://rsavukatlik.com/iletisim"
      />
      {/* Page Header */}
