...
export const regions: Record<string, RegionData> = {
  ...
  'kartal-ceza': {
    ...
    content: `
      ...
      <p>Kartal'daki <strong>İstanbul Anadolu Adliyesi'nde görülen ceza davalarında</strong>, soruşturma ve kovuşturma aşamalarında müvekkillerimizi en etkin şekilde temsil ediyoruz. Türkiye'nin ve dünyanın en büyük adliyelerinden biri olan Anadolu Adliyesi'nin işleyişine ve bölgeye hakimiyetimizle, <a href="/kartal-ceza-avukati" class="text-gold hover:underline font-medium">Kartal Ceza Avukatı</a> olarak sürecin her aşamasında yanınızdayız.</p>
      <p>Özellikle uyuşturucu, hırsızlık, dolandırıcılık, tehdit ve hakaret gibi suç tiplerinde; ifade, gözaltı ve tutuklama süreçlerinden mahkeme aşamasına kadar titiz bir savunma stratejisi yürütüyoruz.</p>
